...
export const RoutineProblemSection: React.FC = () => {
  ...
  const points = [
    ...
    <> <strong className="text-white">A montanha russa financeira:</strong> Você olha para a agenda do mês que vem e sente um frio na barriga porque não faz ideia de onde virão os próximos clientes pagantes.</>
  ];
