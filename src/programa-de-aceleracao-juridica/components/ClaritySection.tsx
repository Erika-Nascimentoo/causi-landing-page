      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="flex flex-col gap-6 mb-16 reveal-hidden text-center max-w-5xl mx-auto px-4">
          <h2 className="text-2xl md:text-4xl font-medium text-text-primary leading-tight">
            Já o <span className="text-brand-primary font-bold">Advogado Estrategista</span> parou de culpar o mercado e instalou um <span className="text-brand-primary font-bold">Sistema Operacional de Receita</span> para consertar as três falhas que impedem a sua advocacia de crescer
          </h2>
        </header>
