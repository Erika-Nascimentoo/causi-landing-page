        ...
        <section id="offer" ref={sectionRef} className="py-20 md:py-32 px-6 bg-bg-page relative overflow-hidden">
            ...
            <div className="max-w-2xl mx-auto relative z-10">
                ...
                <div className="reveal-hidden max-w-lg mx-auto">
                    <div className="bg-white border border-slate-200 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-[0_0_100px_30px_rgba(255,255,255,0.4)] flex flex-col items-center">
