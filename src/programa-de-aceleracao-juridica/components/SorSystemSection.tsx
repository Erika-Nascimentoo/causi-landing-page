  ...
  if (isBonus) {
    return (
      <li className="relative flex flex-col items-center justify-center p-6 mt-8 border-2 border-brand-primary rounded-2xl group text-center">
        <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-brand-primary text-white text-[10px] uppercase tracking-widest font-bold h-6 px-4 rounded-full flex items-center justify-center gap-1.5 leading-none pt-[1px]">
