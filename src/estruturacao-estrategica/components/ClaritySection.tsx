        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <header className="flex flex-col gap-6 lg:sticky lg:top-32 reveal-hidden">
            <h2 className="type-h2 text-text-primary">
              Como a <span className="text-brand-primary">Estruturação Estratégica</span> monta sua <span className="text-text-primary">máquina</span>
            </h2>
            <p className="type-body-lg text-text-secondary">
              A <strong className="text-text-primary">Estruturação Estratégica</strong> entrega sua <strong className="text-text-primary">Máquina de Fechar Contratos</strong> em apenas 4 semanas. Saímos do diagnóstico e instalamos a estrutura completa para você parar de depender da sorte.
            </p>
          </header>
